            ...
            <div className="border-b-2 border-solid border-black border-opacity-20">
                <Container>
                    <div className="pt-6 md:pt-12 2xl:pt-16 pb-4">
                        <RadioTitle title="Global Security Context" />
                    </div>
                </Container>
            </div>
            <div className="">
                    ...
                    <div className="flex flex-row-reverse lg:flex-row">
                        ...
                        <div className="grow p-6 md:p-10 max-lg:!pl-0 lg:pr-0">
                            ...
                            <div className="mt-12 md:mt-[5rem]">
                                <h3>Global Incidents in News</h3>
                                    ...
                                    {articlesData
                                        ...
                                        .map((article) => {
                                            return (
                                                <div
                                                    key={article?.id}
                                                    className="card px-3 mb-6 w-full sm:w-1/2 2xl:w-1/3"
                                                >
                                                    <div className="inner flex flex-col p-5 h-full border-2 border-solid border-black border-opacity-20 rounded-md">
                                                        {article?.year && (
                                                            <Chip
                                                                variant="bordered"
                                                                className="h6 px-2 md:px-2.5 md:py-0.5 mb-4 md:mb-5 border-black border-opacity-50 h-auto"
                                                            >
                                                                {article?.year}
                                                            </Chip>
                                                        )}
                                                        ...
                                                        {article?.title && (
                                                            <h5 className="font-semibold mb-4 md:mb-6 2xl:mb-8">
                                                                {article?.title}
                                                            </h5>
                                                        )}
                                                        {article?.desc && (
                                                            <p className="mb-8 md:mb-12 2xl:mb-16">
                                                                {article?.desc}
                                                            </p>
                                                        )}
                                                        ...
                                                        {article?.btnText && (
                                                            <Button
                                                                ...
                                                                target="_blank"
                                                                className="button group !py-[1rem] md:!py-[1.125rem] mt-auto !w-full !rounded-[4px]"
                                                            >
                                                                {
                                                                    article?.btnText
                                                                }{" "}
