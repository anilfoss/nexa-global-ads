...
const HeroCapabilities = () => {
    ...
    // 🔹 GSAP text animation
    useGSAP(() => {
        const splitTitle = new SplitText(".section-capabilities-hero .title", {
    ...
    return (
        <Section className="section-capabilities-hero content-end pt-28 md:pt-40 pb-12 md:pb-20 min-h-svh relative z-[1] overflow-hidden">
            ...
            <video
                ...
                preload="auto"
            >
                <source src="/images/capabilities-video.mp4" type="video/mp4" />
            </video>
        </Section>
    );
};
