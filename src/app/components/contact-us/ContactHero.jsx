...
const ContactHero = () => {
    ...
    // 🔹 GSAP text animation
    useGSAP(() => {
        const splitTitle = new SplitText(".section-contact-hero .title", {
            type: "lines, words, chars",
            tag: "span",
            charsClass: "chars",
        });
        const splitDescription = new SplitText(
            ".section-contact-hero .description",
            {
                type: "lines, words",
                tag: "span",
                linesClass: "lines",
    ...
    return (
        <Section className="section-contact-hero content-end pt-28 md:pt-40 pb-12 md:pb-20 min-h-svh relative z-[1] overflow-hidden">
            <Container className="relative z-[2]">
                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center lg:gap-4 relative">
                    ...
                    <div className="description text-medium lg:text-[clamp(0.9rem,0.5rem+0.625vw,1.25rem)] text-white text-opacity-70 max-lg:mt-4 max-w-full lg:max-w-[22rem] xl:max-w-[24rem] opacity-0">
                        Our team is ready to listen and help. Tell us about your
                        project and we’ll respond with a clear next step.
                    </div>
                </div>
            </Container>
            ...
            >
                <Image
                    src="/images/contact-video-placeholder.jpg"
